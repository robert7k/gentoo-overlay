...
EGO_SUM=(
	...
	"charm.land/glamour/v2 v2.0.1/go.mod"
	...
	"github.com/GoogleCloudPlatform/opentelemetry-operations-go/detectors/gcp v1.33.0/go.mod"
	...
	"github.com/JohannesKaufmann/dom v0.3.1/go.mod"
	"github.com/JohannesKaufmann/html-to-markdown/v2 v2.5.2"
	"github.com/JohannesKaufmann/html-to-markdown/v2 v2.5.2/go.mod"
	...
	"github.com/anthropics/anthropic-sdk-go v1.61.0/go.mod"
	...
	"github.com/cockroachdb/apd/v3 v3.2.3/go.mod"
	...
	"github.com/dolthub/dolt/go v0.40.5-0.20260715172757-a6690826d767/go.mod"
	"github.com/dolthub/driver/v2 v2.2.0"
	"github.com/dolthub/driver/v2 v2.2.0/go.mod"
	"github.com/dolthub/eventkit v0.0.0-20260611184414-99f5693e696a"
	"github.com/dolthub/eventkit v0.0.0-20260611184414-99f5693e696a/go.mod"
	...
	"github.com/dolthub/fslock v0.0.5/go.mod"
	"github.com/dolthub/go-icu-regex v0.0.0-20260610153742-72563bc7ca83"
	"github.com/dolthub/go-icu-regex v0.0.0-20260610153742-72563bc7ca83/go.mod"
	"github.com/dolthub/go-mysql-server v0.20.1-0.20260713210757-6d01d00bbbf3"
	"github.com/dolthub/go-mysql-server v0.20.1-0.20260713210757-6d01d00bbbf3/go.mod"
	...
	"github.com/dolthub/ishell v0.0.0-20260414231531-5f031e3e9037/go.mod"
	...
	"github.com/dolthub/vitess v0.0.0-20260624214226-81d034e0fde8/go.mod"
	...
	"github.com/go-sql-driver/mysql v1.10.0/go.mod"
	...
	"github.com/invopop/jsonschema v0.14.0/go.mod"
	...
	"github.com/lestrrat-go/strftime v1.2.0/go.mod"
	...
	"github.com/mattn/go-sqlite3 v1.14.49/go.mod"
	...
	"github.com/oapi-codegen/oapi-codegen/v2 v2.6.0/go.mod"
	...
	"github.com/speakeasy-api/jsonpath v0.6.0/go.mod"
	"github.com/speakeasy-api/openapi-overlay v0.10.2"
	"github.com/speakeasy-api/openapi-overlay v0.10.2/go.mod"
	...
	"github.com/standard-webhooks/standard-webhooks/libraries v0.0.1/go.mod"
	...
	"github.com/testcontainers/testcontainers-go/modules/dolt v0.43.0/go.mod"
	...
	"github.com/woodsbury/decimal128 v1.3.0/go.mod"
	...
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp v1.45.0/go.mod"
	"go.opentelemetry.io/otel/exporters/stdout/stdoutmetric v1.45.0"
	"go.opentelemetry.io/otel/exporters/stdout/stdoutmetric v1.45.0/go.mod"
	...
	"google.golang.org/api v0.264.0/go.mod"
	...
	"google.golang.org/genproto/googleapis/api v0.0.0-20260803160001-6ac0973c030d/go.mod"
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20260803160001-6ac0973c030d"
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20260803160001-6ac0973c030d/go.mod"
...
src_test() {
	...
	ego test -skip "TestIsPathInSafeBoundary|TestCheckDeletionsManifest_LegacyFile" ./...
}
